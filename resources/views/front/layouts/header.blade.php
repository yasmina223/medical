  ...
  <div id="topbar" class="d-flex align-items-center fixed-top">
    <div class="container d-flex align-items-center justify-content-center justify-content-md-between">
      <div class="align-items-center d-none d-md-flex">
        <i class="bi bi-clock"></i> {{$settings[0]->from_day}} - {{$settings[0]->to_day}}, {{$settings[0]->from_time}}AM to {{$settings[0]->to_time}}PM
      </div>
      <div class="d-flex align-items-center">
        <i class="bi bi-phone"></i> Call us now {{$settings[0]->phone}}
      </div>
    </div>
  </div>
    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="{{route('about_us')}}">About</a></li>
          <li><a class="nav-link scrollto" href="{{route('services')}}">Services</a></li>
          <li><a class="nav-link scrollto" href="{{route('departments')}}">Departments</a></li>
      ...
      <a href="{{route('appoinment')}}" class="appointment-btn scrollto"><span class="d-none d-md-inline">Make an</span> Appointment</a>
